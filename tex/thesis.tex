...
\title{Large Wireless Model for Resource Allocation in Wireless Massive MIMO Communication}
...
\def\titlelineA{~}
\def\titlelineB{Large Wireless Model}
\def\titlelineC{for Resource Allocation in Wireless }
\def\titlelineD{Massive MIMO Communication}
% Further information
\def\thesistype{master's thesis}
\def\thesistypegerman{Masterarbeit}
\def\expecteddegree{Master of Science}
\def\fieldofstudy{Electrical Engineering, Information Technology and Computer Engineering}
\def\supervisor{Dr.-Ing. Shirin Salehi} % Not professor
